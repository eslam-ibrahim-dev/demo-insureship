...
class SuperclientService
{
    public function index()
    {
        ...
        $superclients = SuperClient::with(['clients:id,superclient_id,name'])->get(['id', 'name']);

        $data = $superclients->map(function ($superclient) {
            return [
                'id' => $superclient->id,
                'name' => $superclient->name,
                'clients' => $superclient->clients->map(function ($client) {
                    return [
                        'id' => $client->id,
                        'name' => $client->name,
                    ];
