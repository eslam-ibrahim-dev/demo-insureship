...
class SubClient extends Model
{
    ...
    protected $fillable = [
        'id', 'client_id', 'name', 'referral_id', 'apikey',
        'username', 'password', 'salt', 'email_timeout',
        'distributor_id', 'affiliate_id', 'store_id', 'll_customer_id', 'll_api_policy_id', 'll_key',
        'website', 'is_test_account',
